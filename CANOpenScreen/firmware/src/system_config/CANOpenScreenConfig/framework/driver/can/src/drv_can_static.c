...
static CAN_TX_MSG_BUFFER  can_message_buffer0[3*2*16];
...
void DRV_CAN0_Initialize(void)
{
    ...
    PLIB_CAN_ChannelForReceiveSet(CAN_ID_1, CAN_CHANNEL0, 1, CAN_RX_FULL_RECEIVE);
    ...
    PLIB_CAN_FilterToChannelLink(CAN_ID_1, CAN_FILTER0, CAN_FILTER_MASK0, CAN_CHANNEL2);
